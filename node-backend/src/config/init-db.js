...
async function initDB(db) {
    try {
        ...
        if (rows.length === 0) {
            ...
            // Ejecutar el SQL (el adaptador se encarga de convertirlo si es necesario)
            // Para PostgreSQL plano, dividimos por punto y coma si es necesario o ejecutamos todo
            await db.query(sql);
